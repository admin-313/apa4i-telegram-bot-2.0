...
auth_middleware = AuthMiddleware(config_reader)
auth_middleware_router.message.outer_middleware(auth_middleware)
auth_middleware_router.callback_query.outer_middleware(auth_middleware)